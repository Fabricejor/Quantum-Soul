...
export interface FAQWithSpiralProps {
  title?: string;
  subtitle?: string;
  faqs?: FAQItemData[];
  ctaText?: string;
...
export default function FAQWithSpiral({
  title = "FAQ",
  subtitle = "Clean, minimalistic, black‑and‑white.",
  faqs = [
    {
    ...
    >
      ...
      <div className="relative mx-auto max-w-5xl px-6 py-16">
        ...
        <header className="mb-10 flex flex-col md:flex-row md:items-end justify-between border-b border-white/20 pb-6 gap-4">
          <div>
            <h1 className="text-4xl md:text-6xl font-black tracking-tight font-geonova text-white">{title}</h1>
          ...
          <div className="flex items-center gap-3">
            <input
              ...
              className="h-10 w-full md:w-56 rounded-xl border border-white/20 bg-transparent px-3 text-sm outline-none transition focus:border-white/60 text-white"
            />
          </div>
        </header>
        ...
        {(ctaText || ctaButtonText) && (
          <div className="mt-20 flex flex-col items-center justify-center text-center relative z-10 border-t border-white/10 pt-16">
            {ctaText && (
              <h2 className="text-2xl md:text-4xl font-bold font-geonova text-white mb-8">
                {ctaText}
              </h2>
            )}
            {ctaButtonText && (
